...
impl<T: Ring> Gemm<Matrix<T, 3, 3>> for Matrix<T, 3, 3> {
    ...
    fn gemm(self, x: Matrix<T, 3, 3>) -> Matrix<T, 3, 3> {
        ...
        let m3 = self.e[1][1]
            * (-x.e[0][0] + x.e[0][1] + x.e[1][0] - x.e[1][1] - x.e[1][2] - x.e[2][0] + x.e[2][2]);
        let m4 =
        ...
        let m10 = (self.e[0][0] + self.e[0][1] + self.e[0][2]
            ...
            * x.e[1][2];
        let m11 = self.e[2][1]
            * (-x.e[0][0] + x.e[0][2] + x.e[1][0] - x.e[1][1] - x.e[1][2] - x.e[2][0] + x.e[2][1]);
        let m12 =
...
impl<T: Ring> Gemm<Matrix<T, 4, 4>> for Matrix<T, 4, 4> {
    ...
    fn gemm(self, x: Matrix<T, 4, 4>) -> Matrix<T, 4, 4> {
        ...
        let h2 = (self.e[0][0] - self.e[0][2] + self.e[2][0]) * (x.e[0][0] - x.e[0][2] + x.e[2][0]);
        ...
        let h13 = (-self.e[1][2] - self.e[1][3])
            * (-x.e[1][0] + x.e[1][1] - x.e[1][2] - x.e[1][3] - x.e[3][0] + x.e[3][1]
                ...
                - x.e[3][3]);
        let h14 =
            (self.e[0][0] - self.e[0][1] + self.e[1][0] - self.e[1][1]) * (-x.e[0][1] - x.e[0][3]);
        ...
        let h39 =
            (-self.e[0][2] - self.e[0][3] - self.e[1][2] - self.e[1][3]) * (x.e[2][1] + x.e[2][3]);
        ...
        let h45 = (-self.e[1][0] + self.e[1][2] + self.e[3][0] - self.e[3][2])
            * (-x.e[2][0] + x.e[2][1] + x.e[2][2] + x.e[2][3] + x.e[3][0]
                ...
                - x.e[3][3]);
        let h46 =
            (-self.e[2][0] + self.e[2][1] + self.e[3][0] - self.e[3][1]) * (-x.e[0][1] - x.e[2][1]);
        let h47 = (self.e[3][0] - self.e[3][2]) * (-x.e[0][2] - x.e[0][3] - x.e[1][2] - x.e[1][3]);
        ...
        e[0][1] = -h7 + h8 - h10 + h11 - h14 + h15 + h16 - h17 + h18 + h21 - h31 + h33 - h35 - h36;
        e[0][2] = h1 - h2 + h3 - h5 + h33 - h34 + h37 - h40;
        e[0][3] =
            h8 - h10 + h11 - h13 + h17 - h18 - h19 - h21 + h31 - h33 + h34 + h35 + h36 - h37 - h39
                + h40;
        e[1][0] = -h15 - h16 + h17 - h18 - h21 + h22 - h23 + h26 - h33 - h41 + h44 + h49;
        e[1][1] = h7 - h8 + h10 - h11 - h15 - h16 + h17 - h18 - h21 + h22 - h23 + h26 - h33 + h44;
        e[1][2] = h17 - h18 - h19 - h21 - h23 + h24 + h26 - h33 + h34 - h37 + h40 - h43 + h44 + h45
            - h47
            + h49;
        ...
        e[2][1] = -h7 + h8 + h11 + h12 - h16 + h17 - h20 - h21 - h29 - h33 + h34 + h36 + h38 + h46;
        ...
        e[3][0] = -h16 + h17 - h20 - h21 + h22 - h23 + h25 + h26 - h29 - h32 - h33 + h34 + h38
            ...
            + h42
            + h43;
        e[3][1] = -h7 + h8 + h11 + h12 - h16 + h17 - h20 - h21 + h22 - h23 + h25 + h26 - h29 - h33
            + h34
            + h38;
