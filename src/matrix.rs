...
impl<const M: usize, const N: usize> Add<Matrix<M, N>> for Matrix<M, N> {
    ...
    fn add(self, x: Matrix<M, N>) -> Self::Output {
        let mut e = [[0.; M]; N];
        for i in 0..M {
            for j in 0..N {
...
mod tests {
    ...
    #[test]
    fn det_3x3() {
        let a = Matrix::<3, 3>::new([[1., 2., 3.], [4., 5., 3.], [7., 8., 9.]]);
        let b = -18.;
        assert_eq!(a.determinant(), b);
    }
    ...
    fn mult_2x2() {
        let a = Matrix::<2, 2>::new([[1., 2.], [3., 4.]]);
        let b = Matrix::<2, 2>::new([[5., 6.], [7., 8.]]);
        let c = Matrix::<2, 2>::new([[19., 22.], [43., 50.]]);
        assert_eq!(a * b, c);
    }

    #[test]
    fn mult_3x3() {
        let a = Matrix::<3, 3>::new([[1., 2., 3.], [4., 5., 6.], [7., 8., 9.]]);
        let b = Matrix::<3, 3>::new([[9., 8., 7.], [6., 5., 4.], [3., 2., 1.]]);
        let c = Matrix::<3, 3>::new([[30., 24., 18.], [84., 69., 54.], [138., 114., 90.]]);
        assert_eq!(a * b, c);
    }
    ...
    fn testme() {
        ...
        assert_eq!(
            (Matrix::<2, 2>::IDENTITY * y * Matrix::<2, 2>::IDENTITY).determinant(),
            -2.0
        );
